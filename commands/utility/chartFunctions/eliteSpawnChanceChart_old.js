...
const DATA = [
    ...[
        ...
        ['0%', '1%', '500', '450', '405', '365', '328', '295', '266', '239', '215', '194', '174', '157', '141', '127', '114', '41', '37', '33', '30', '27', '24', '1', '1'],
        ['0%', '4%', '1000', '900', '810', '729', '656', '590', '531', '478', '430', '387', '349', '314', '282', '254', '229', '100', '92', '83', '75', '68', '61', '2', '2'],
        ['0%', '9%', '1500', '1350', '1215', '1094', '984', '886', '797', '717', '646', '581', '523', '471', '424', '381', '343', '205', '185', '167', '150', '135', '122', '3', '3'],
        ['0%', '16%', '2000', '1800', '1620', '1458', '1312', '1181', '1063', '957', '861', '775', '697', '628', '565', '508', '458', '308', '277', '250', '225', '203', '182', '4', '4'],
        ['0%', '25%', '3000', '2700', '2430', '2187', '1968', '1771', '1594', '1435', '1291', '1162', '1046', '941', '847', '763', '688', '411', '370', '333', '300', '270', '243', '6', '5'],
        ['0%', '36%', '4000', '3600', '3240', '2916', '2624', '2362', '2126', '1913', '1722', '1550', '1395', '1255', '1130', '1017', '915', '617', '555', '500', '450', '405', '365', '8', '6'],
        ['0%', '49%', '5000', '4500', '4050', '3645', '3281', '2953', '2657', '2391', '2152', '1937', '1743', '1569', '1412', '1271', '1144', '823', '741', '667', '600', '540', '486', '10', '7'],
        ['0%', '64%', '6000', '5400', '4860', '4374', '3937', '3543', '3189', '2870', '2583', '2325', '2092', '1883', '1695', '1525', '1373', '1029', '926', '833', '750', '675', '608', '12', '8'],
        ['0%', '81%', '7000', '6300', '5670', '5103', '4593', '4133', '3720', '3348', '3013', '2712', '2441', '2197', '1977', '1779', '1601', '1235', '1111', '1000', '901', '811', '729', '14', '9'],
        ['1%', '100%', '8000', '7200', '6480', '5832', '5249', '4724', '4252', '3826', '3444', '3099', '2789', '2510', '2259', '2033', '1830', '1441', '1297', '1167', '1051', '946', '851', '16', '10'],
        ['4%', '100%', '9000', '8100', '7290', '6561', '5905', '5314', '4783', '4305', '3874', '3487', '3138', '2824', '2542', '2288', '2059', '1647', '1482', '1334', '1201', '1081', '973', '18', '11'],
        ['9%', '100%', '10000', '9000', '8100', '7290', '6561', '5905', '5314', '4783', '4305', '3874', '3487', '3138', '2824', '2542', '2288', '1806', '1627', '1461', '1351', '1216', '1094', '20', '12'],
        ['16%', '100%', '11000', '9900', '8910', '8019', '7217', '6495', '5846', '5261', '4735', '4256', '3821', '3425', '3082', '2774', '2500', '1965', '1771', '1593', '1501', '1351', '1216', '22', '13'],
        ['25%', '100%', '12000', '10800', '9720', '8748', '7873', '7086', '6377', '5740', '5166', '4649', '4184', '3766', '3387', '3050', '2754', '2264', '2038', '1834', '1651', '1486', '1337', '24', '14'],
        ['36%', '100%', '13000', '11700', '10530', '9477', '8529', '7676', '6909', '6218', '5596', '5036', '4533', '4080', '3672', '3305', '2974', '2470', '2223', '2003', '1801', '1621', '1459', '26', '15'],
        ['49%', '100%', '14000', '12600', '11340', '10206', '9185', '8267', '7440', '6696', '6027', '5424', '4881', '4393', '3954', '3559', '3203', '2676', '2408', '2168', '1951', '1756', '1580', '28', '16'],
        ['64%', '100%', '15000', '13500', '12150', '10935', '9836', '8852', '7967', '7171', '6457', '5811', '5230', '4707', '4236', '3813', '3432', '2882', '2594', '2333', '2101', '1891', '1702', '30', '17'],
        ['81%', '100%', '16000', '14400', '12960', '11664', '10498', '9448', '8503', '7653', '6887', '6200', '5580', '5023', '4519', '4067', '3660', '3088', '2779', '2501', '2251', '2026', '1824', '32', '18'],
        ['100%', '100%', '17000', '15300', '13770', '12393', '11154', '10038', '9034', '8131', '7318', '6586', '5928', '5335', '4801', '4321', '3889', '3294', '2964', '2668', '2402', '2161', '1945', '34', '19']
    ]
];
...
async function generateEliteSpawnChanceChart() {
    ...
    // Set reference columns to a more reasonable width
    ctx.font = cellFont;
    const refTextWidth = Math.max(ctx.measureText('34').width, ctx.measureText('19').width);
    const refColumnWidth = Math.ceil(refTextWidth) + 8; // Reduced padding for reference columns
    colWidths[23] = refColumnWidth;
    colWidths[24] = refColumnWidth;
    // Modifiers table data (from spreadsheet)
    // First column is empty, then a single spanned header for Modifiers (Rounded), then T1-T21
    const MODIFIERS_HEADER = ['', { label: 'Modifiers (Rounded):', span: 21 }];
    const MODIFIERS_ROW_LABEL = 'Ratio';
    const MODIFIERS_ROW = ['0.9', '500.00', '450.00', '405.00', '364.50', '328.05', '295.25', '265.72', '239.15', '215.23', '193.71', '174.34', '156.91', '141.21', '127.09', '114.38', '102.95', '92.65', '83.39', '75.05', '67.54', '60.79'];

    // Calculate modifiers colWidths (align with main table columns)
    // First column is empty, then T1-T21 columns (colWidths[2]..colWidths[22])
    ...
    // Draw table headers (first 23 as normal, last 2 as merged 'reference')
    let x = 0;
    let y = margin / 2 + titleHeight;
    ctx2.font = headerCellFont;
    ctx2.textAlign = 'center';
    ctx2.textBaseline = 'middle';
    // Draw first 23 headers as normal
    for (let i = 0; i < 23; i++) {
    ...
    let refHeaderX = x;
    let refHeaderWidth = colWidths[23] + colWidths[24];
    ctx2.fillStyle = headerBg;
    ...
    ctx2.textAlign = 'center';
    ctx2.textBaseline = 'middle';
    ctx2.fillText('Ref.', refHeaderX + refHeaderWidth / 2, y + headerHeight / 2);
    y += headerHeight;
    ...
    // Draw modifiers header row: 'Ratio' and 'Modifiers (Rounded):' in the same row, lined up with T1-T21 columns
    ...
    let spanWidth = 0;
    for (let i = 2; i <= 22; i++) spanWidth += colWidths[i];
    ctx2.fillStyle = headerBg;
    ...
    // Draw modifiers value row (0.9, 500.00, ...), lined up with T1-T21 columns
    modX = colWidths[0];
